        ...
        <div className="container relative z-10" style={{ zIndex: 2, textAlign: 'center', color: '#fff', padding: '0 2rem' }}>
          <div className="hero-content" style={{ animation: 'fadeInUp 1s ease-out' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Link to="/experts" className="btn-secondary" style={{ padding: '0.8rem 2rem', fontSize: '1rem', borderRadius: '50px', background: 'rgba(255,255,255,0.1)', color: '#fff', border: '1px solid rgba(255,255,255,0.2)', backdropFilter: 'blur(10px)', transition: 'all 0.3s ease', minWidth: '200px', display: 'inline-block' }}>
                {t('hero.btn.expert')}
              </Link>
            </div>
          </div>
